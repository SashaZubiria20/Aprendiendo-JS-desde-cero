...
if (indexedDB1 && formDB) {
    ...
    // Paso 5: creamos la funcion de eliminar
    ...
    const readData = () => {
        ...
        request.onsuccess = (e) => {
            ...
            if (cursor) {
                ...
                // Paso 5: hacemos lo mismo con el boton de borrar
    ...
    tasks.addEventListener('click', (e) => {
        if (e.target.dataset.type == 'update') {
            ...
            // Paso 5: vemos si la opcion es delete, en ese caso llamamos a la funcion
